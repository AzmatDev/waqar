...
async function buildAndSendOrderEmails({ items, nom, email, tel, adresse, codepostal, ville, pays, tailleCm, poidsKg, modeReception, paiement }) {
    ...
    await transporter.sendMail({
        ...
        to: 'azmat.chwt@gmail.com', // TEMPORAIRE — test Netlify, remettre waqar.1447h@gmail.com après validation
...
exports.buildAndSendOrderEmails = buildAndSendOrderEmails;
